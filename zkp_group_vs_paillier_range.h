...
#define ZKP_GROUP_VS_PAILLIER_PROOF_BYTES (GROUP_ELEMENT_BYTES + 3*RING_PED_MODULUS_BYTES + 3*PAILLIER_MODULUS_BYTES + 2*ELL_ZKP_RANGE_PARAMETER_BYTES + 2*EPS_ZKP_SLACK_PARAMETER_BYTES)
